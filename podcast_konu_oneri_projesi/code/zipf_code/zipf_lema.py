...
def main():
    df = pd.read_csv("ciktilar/tfidf_lemmatized.csv")
    texts = df['text'].dropna().tolist()
    plot_zipf(texts, "ciktilar/zipf_dosyalari/grafikler/zipf_lema_loglog.png")
    print("Zipf grafiği (lemmatized) oluşturuldu.")
